...
// Component 6
files['src/components/Component6/Component6.tsx'] = import React from 'react'
...
export const Component6: React.FC<Component6Props> = ({
  ...
  return (
    <button
      id={\component6-\\}
      className={\Component6 Component6--\ \\}
      onClick={onClick}
      disabled={isDisabled}
...
files['src/components/Component6/Component6.stories.tsx'] = import type { Meta, StoryObj } from '@storybook/react'
...
**Figma Source:** Frame cta button (ID: 53:1090), ComponentSet Component 6

A compact 72x72px square CTA icon+label button.
        \,
      },
    },
  },
...
// Component 7
files['src/components/Component7/Component7.tsx'] = import React from 'react'
...
export const Component7: React.FC<Component7Props> = ({
  ...
  return (
    <div
      id={\component7-\\}
      className={\Component7 Component7--\ \\}
      role=article
...
files['src/components/Component7/Component7.stories.tsx'] = import type { Meta, StoryObj } from '@storybook/react'
...
// Component 9
files['src/components/Component9/Component9.tsx'] = import React from 'react'
...
files['src/components/Component9/Component9.stories.tsx'] = import type { Meta, StoryObj } from '@storybook/react'
...
// Component 10
files['src/components/Component10/Component10.tsx'] = import React from 'react'
...
export const Component10: React.FC<Component10Props> = ({
  ...
  const variantClass = \Component10--\\
...
files['src/components/Component10/Component10.stories.tsx'] = import type { Meta, StoryObj } from '@storybook/react'
...
// Component 11
files['src/components/Component11/Component11.tsx'] = import React from 'react'
...
export const Component11: React.FC<Component11Props> = ({
  ...
  const variantClass = \Component11--\\
  const isDisabled = property1 === 'disabled'
...
files['src/components/Component11/Component11.stories.tsx'] = import type { Meta, StoryObj } from '@storybook/react'
